...
default[:magento][:user] = 'user'
default[:magento][:group] = 'group'


# Required packages
case node["platform_family"]
when "rhel", "fedora"
  default[:magento][:packages] = ['php-cli', 'php-common', 'php-curl', 'php-gd', 'php-mcrypt', 'php-mysql', 'php-pear', 'php-pecl-apc', 'php-xml']
else
